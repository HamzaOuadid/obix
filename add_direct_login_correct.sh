...
# Create direct login view with correct container name
echo "Setting up direct login (using correct container name)..."
...
# Copy the view file to the container using correct name
...
echo "Copying login test page to frontend container (obix_frontend_1)..."
